...
- לחשוב שאני אמות - אבל האידאות והאינפורמציה שזורמת דרכי כל הזמן תמשיך להתקיים. 

### תרגיל 2: מילים שנמצאות במחשבה

-  לתפוס מחשבה אוטומטית, ולחזור על המילה הראשונה הרבה פעמים, עד שהמשמעות נעלמת ונשאר רק הצליל. אפשר לעוות את הצליל קצת.  
...
- לתפוס משפט של מחשבה אוטומטית. לחדד את הדמיון שעולה, מתי הוא ואיפה הוא? מיד שהבנו זאת משחררים אותו, וחוזרים להווה.
...
- לבחור אובייקט שאפשר לבחון. הרבה אנשים עמלו עליו במשך זמן רב. להכנס לראש של אנשים שהמציאו אותו. זהו רעיון בקפסולה של חפץ

### תרגיל 6: קונטקסט של אובייקטים מתוכננים

-  לקחת אובייקט מורכב. לשים לב שלכל חלק בתוכו יש מטרה. מה המטרה של החפץ עצמו? האם הוא חלק מהרכבה גדולה יותר גם? 

### תרגיל 7: אובייקטים טבעיים - אבולוציה

- להרגיש יצור בן 3 מיליארד שנה צאצא של המשתכפל הראשון, והתודעה היא אשליה אופטית של תאים נוירוניים. 

### תרגיל 8: המיינד מייצר הולוגרמה 

- להרגיש את ההולוגרמה שמייצר המח, ואיך ההולוגרמה של המח היא חלקיק מפרקטל הולוגרמי של היקום כולו. 
 
### תרגיל 9: ההולוגרמה נעלמת, זה חלק מהטריק 

- לקחת חפץ לשכוח מהתרגיל ואז להזכר בהולוגרמה. כששכחנו היה חלק מהטריק של המח שלא נשים לב למורכבות, כדי שנתפקד. 
...
- לשים לב שהזזת היד אין בה מילים, אנחנו לא חושבים אני אזיז יד. לנסות להרים יד ימין ושמאל ולהבין איך זה נעשה ללא מילים. 

### תרגיל 11: המעבר בנפש בין כוונה לבין פעולה 

- לעשות פעולה כמו להכין קפה או לנקות, בקצב מואט. לשים לב לפרויקציה לעתיד שמתרחשת כל הזמן, אני מדמיין עושה פעולה ואז עושה אותה. 
...
- המרכז התודעתי נע על סקאלות זמן שונות. לחשוב על עצמי לפני שבוע, חודש, שנה, 10 שנים. לא היה אני לפני 200 שנה אבל היתה תרבות.
...
- להגיד הרבה הברות וצלילים. לקחת כמה עיצורים ולהגיד אותם ללא משמעות. אפשר פשוט לדבר בג'יבריש. למשל
